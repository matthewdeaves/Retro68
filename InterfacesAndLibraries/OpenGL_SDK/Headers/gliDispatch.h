...
typedef struct __GLIExtensionDispatchRec {
	GLint ext_count;	/* 38 */
	void (*blend_color_EXT)(GLIContext ctx, GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha);
	...
	void (*multi_tex_coord1dv_ARB)(GLIContext ctx, GLenum target, const GLdouble *v);
	void (*multi_tex_coord1f_ARB)(GLIContext ctx, GLenum target, GLfloat s);
	void (*multi_tex_coord1fv_ARB)(GLIContext ctx, GLenum target, const GLfloat *v);
	...
	void (*multi_tex_coord1sv_ARB)(GLIContext ctx, GLenum target, const GLshort *v);
	void (*multi_tex_coord2d_ARB)(GLIContext ctx, GLenum target, GLdouble s, GLdouble t);
	void (*multi_tex_coord2dv_ARB)(GLIContext ctx, GLenum target, const GLdouble *v);
	void (*multi_tex_coord2f_ARB)(GLIContext ctx, GLenum target, GLfloat s, GLfloat t);
	void (*multi_tex_coord2fv_ARB)(GLIContext ctx, GLenum target, const GLfloat *v);
	void (*multi_tex_coord2i_ARB)(GLIContext ctx, GLenum target, GLint s, GLint t);
	void (*multi_tex_coord2iv_ARB)(GLIContext ctx, GLenum target, const GLint *v);
	void (*multi_tex_coord2s_ARB)(GLIContext ctx, GLenum target, GLshort s, GLshort t);
	void (*multi_tex_coord2sv_ARB)(GLIContext ctx, GLenum target, const GLshort *v);
	void (*multi_tex_coord3d_ARB)(GLIContext ctx, GLenum target, GLdouble s, GLdouble t, GLdouble r);
	void (*multi_tex_coord3dv_ARB)(GLIContext ctx, GLenum target, const GLdouble *v);
	void (*multi_tex_coord3f_ARB)(GLIContext ctx, GLenum target, GLfloat s, GLfloat t, GLfloat r);
	void (*multi_tex_coord3fv_ARB)(GLIContext ctx, GLenum target, const GLfloat *v);
	void (*multi_tex_coord3i_ARB)(GLIContext ctx, GLenum target, GLint s, GLint t, GLint r);
	void (*multi_tex_coord3iv_ARB)(GLIContext ctx, GLenum target, const GLint *v);
	void (*multi_tex_coord3s_ARB)(GLIContext ctx, GLenum target, GLshort s, GLshort t, GLshort r);
	void (*multi_tex_coord3sv_ARB)(GLIContext ctx, GLenum target, const GLshort *v);
	void (*multi_tex_coord4d_ARB)(GLIContext ctx, GLenum target, GLdouble s, GLdouble t, GLdouble r, GLdouble q);
	void (*multi_tex_coord4dv_ARB)(GLIContext ctx, GLenum target, const GLdouble *v);
	void (*multi_tex_coord4f_ARB)(GLIContext ctx, GLenum target, GLfloat s, GLfloat t, GLfloat r, GLfloat q);
	void (*multi_tex_coord4fv_ARB)(GLIContext ctx, GLenum target, const GLfloat *v);
	void (*multi_tex_coord4i_ARB)(GLIContext ctx, GLenum target, GLint s, GLint t, GLint r, GLint q);
	void (*multi_tex_coord4iv_ARB)(GLIContext ctx, GLenum target, const GLint *v);
	void (*multi_tex_coord4s_ARB)(GLIContext ctx, GLenum target, GLshort s, GLshort t, GLshort r, GLshort q);
	void (*multi_tex_coord4sv_ARB)(GLIContext ctx, GLenum target, const GLshort *v);
	...
	void (*compressed_tex_image3D_ARB)(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid *data);
	void (*compressed_tex_image2D_ARB)(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *data);
	void (*compressed_tex_image1D_ARB)(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid *data);
	void (*compressed_tex_sub_image3D_ARB)(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid *data);
	void (*compressed_tex_sub_image2D_ARB)(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *data);
	void (*compressed_tex_sub_image1D_ARB)(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid *data);
	void (*get_compressed_tex_image_ARB)(GLIContext ctx, GLenum target, GLint level, void *img);
	
	void (*secondaryColor3b_EXT)(GLIContext ctx, GLbyte red, GLbyte green, GLbyte blue);
	void (*secondaryColor3bv_EXT)(GLIContext ctx, const GLbyte *v);
	void (*secondaryColor3d_EXT)(GLIContext ctx, GLdouble red, GLdouble green, GLdouble blue);
	void (*secondary_color3dv_EXT)(GLIContext ctx, const GLdouble *v);
	void (*secondary_color3f_EXT)(GLIContext ctx, GLfloat red, GLfloat green, GLfloat blue);
	void (*secondary_color3fv_EXT)(GLIContext ctx, const GLfloat *v);
	void (*secondary_color3i_EXT)(GLIContext ctx, GLint red, GLint green, GLint blue);
	void (*secondary_color3iv_EXT)(GLIContext ctx, const GLint *v);
	void (*secondary_color3s_EXT)(GLIContext ctx, GLshort red, GLshort green, GLshort blue);
	void (*secondary_color3sv_EXT)(GLIContext ctx, const GLshort *v);
	void (*secondary_color3ub_EXT)(GLIContext ctx, GLubyte red, GLubyte green, GLubyte blue);
	void (*secondary_color3ubv_EXT)(GLIContext ctx, const GLubyte *v);
	void (*secondary_color3ui_EXT)(GLIContext ctx, GLuint red, GLuint green, GLuint blue);
	void (*secondary_color3uiv_EXT)(GLIContext ctx, const GLuint *v);
	void (*secondary_color3us_EXT)(GLIContext ctx, GLushort red, GLushort green, GLushort blue);
	void (*secondary_color3usv_EXT)(GLIContext ctx, const GLushort *v);
	void (*secondary_color_pointer_EXT)(GLIContext ctx, GLint size, GLenum type, GLsizei stride, GLvoid *pointer);
	...
	void (*tex_image3D)(GLIContext ctx, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
...
typedef struct __GLIFunctionDispatchRec {
	...
	void (*tex_image1D)(GLIContext ctx, GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
	void (*tex_image2D)(GLIContext ctx, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
